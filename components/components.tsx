...
export const SplashScreen: React.FC = () => (
  ...
  <div className="flex h-screen w-screen items-center justify-center bg-slate-900 overflow-hidden relative">
    ...
    <div className="text-center z-10">
      {/* Logo and Text separated for clarity. */}
      <div className="flex flex-col items-center justify-center animate-scale-in">
          <Icons.logoIcon className="w-24 h-24 mb-4" />
          <h1 className="text-4xl font-bold text-white tracking-tight">Mira Attendance</h1>
      </div>
